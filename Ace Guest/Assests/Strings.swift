...
struct Strings {
    ...
    static let registerBody = "Registreer uw apparaat met e-mail en uitnodigingscode om toegang te krijgen tot uw beschikbare toegangspas."
    ...
    static let codeRegisterBody = "Voer uw mail en 6-cijferige code in die u via de mail heeft ontvangen"
    static let codeInputPlaceholder = "•"
    static let confirm = "Bevestig"
    static let confirmError = "Deze code is niet geldig"
    ...
    static let continuee = "Ga verder"
    ...
    static let alertFailedAccessBody = "Te veel mislukte pogingen. Probeer het over 5 minuten opnieuw of Raadpleeg de receptie"
    static let ok = "Ok"
